...
export default function DesignsPage() {
  ...
  return (
    <section id="designs" className="scroll-mt-20 animate-fade-up">
      <div className="mb-8 sm:mb-12">
        <SectionLabel>Design Portfolio</SectionLabel>
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-black italic uppercase tracking-tight leading-none mt-2">
          Designs Archive<span className="text-primary not-italic tracking-normal">.</span>
        </h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {currentItems.map((proj, i) => (
          <Card key={i} className="card-hover flex flex-col group border-border/50 bg-card/40 backdrop-blur-sm rounded-[2rem] overflow-hidden transition-all duration-500 hover:border-primary/30 hover:shadow-2xl hover:shadow-primary/5">
            ...
            <CardFooter className="mt-auto px-5 sm:px-6 pb-6 pt-4 border-t border-border/5">
              <Button 
                ...
                size="sm" 
                asChild
                className="w-full text-[10px] font-black uppercase tracking-widest h-10 gap-2 border-primary/20 bg-primary/5 hover:bg-primary/10 text-primary transition-all rounded-xl shadow-sm"
              >
