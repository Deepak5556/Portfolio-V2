  ...
  return (
    <div 
      ...
      className={cn(
        ...
        isFullscreen ? "rounded-0" : "rounded-[2.5rem] border border-white/5 shadow-2xl"
      )}
    ...
    >
      ...
      <motion.div 
        ...
        className="absolute top-0 left-0 right-0 p-8 flex justify-between items-start z-30"
      >
        <div className="flex flex-col">
           <span className="text-[10px] font-black uppercase tracking-[0.3em] text-white/40 mb-1">Portfolio Archive</span>
           <h4 className="text-white font-black uppercase italic tracking-tight text-lg">Case Study Node<span className="text-primary">.</span></h4>
        </div>
        <div className="flex gap-2">
           <Button variant="ghost" size="icon" onClick={handleFullscreen} className="h-10 w-10 rounded-full bg-white/5 border border-white/10 text-white hover:bg-white/10 transition-all">
      ...
      <motion.div 
        animate={{ y: showControls ? 0 : 20, opacity: showControls ? 1 : 0 }}
        className="absolute bottom-0 left-0 right-0 p-6 sm:p-10 z-30 flex flex-col gap-6"
      >
        {/* Progress Bar */}
        <div className="relative group/progress px-2">
           ...
           <div className="flex justify-between mt-3 px-1">
              <span className="text-[10px] font-bold text-white/40 tabular-nums uppercase tracking-widest">{formatTime(currentTime)}</span>
              <span className="text-[10px] font-bold text-white/40 tabular-nums uppercase tracking-widest">{formatTime(duration)}</span>
           </div>
        </div>
        ...
        <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 sm:gap-6">
               <div className="flex items-center gap-1 sm:gap-2">
                  <Button variant="ghost" size="icon" onClick={() => skip(-10)} className="h-10 w-10 rounded-full text-white/60 hover:text-white hover:bg-white/5">
                  ...
                  <Button 
                    ...
                    size="icon" 
                    onClick={togglePlay}
                    className="h-14 w-14 rounded-full bg-white/5 border border-white/10 text-white hover:bg-white/10 transition-all shadow-xl"
                  >
               ...
               <div 
                 className="flex items-center gap-3 bg-white/5 border border-white/10 px-4 h-12 rounded-2xl relative"
            ...
            <div className="flex items-center gap-3">
               ...
               <Button variant="ghost" size="icon" className="h-11 w-11 rounded-full bg-white/5 border border-white/10 text-white hover:bg-white/10">
                  <Sliders size={20} />
               </Button>
            </div>
        </div>
